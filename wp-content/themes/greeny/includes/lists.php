...
if ( ! function_exists('greeny_get_not_selected_text') ) {
	/**
	 ...
	 */
	function greeny_get_not_selected_text( $label ) {
		return apply_filters( 'greeny_filter_not_selected_text',
								sprintf( apply_filters( 'greeny_filter_not_selected_mask', __( '- %s -', 'greeny' ) ), $label )
							);
	}
}

if ( ! function_exists( 'greeny_get_list_range' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_range( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			$list[ $i ] = $i;
		}
...
if ( ! function_exists( 'greeny_get_list_styles' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_styles( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			// Translators: Add number to the style name 'Style 1', 'Style 2' ...
			$list[ $i ] = sprintf( esc_html__( 'Style %d', 'greeny' ), $i );
		}
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_yesno' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_yesno( $prepend_inherit = false ) {
		$list = array(
			'yes' => esc_html__( 'Yes', 'greeny' ),
			'no'  => esc_html__( 'No', 'greeny' ),
		);
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_checkbox_values' ) ) {
	/**
	 ...
	 * @return array                 An associative array with 'yes' and 'no' elements.
	 */
	function greeny_get_list_checkbox_values( $prepend_inherit = false ) {
		$list = apply_filters(
			'greeny_filter_list_checkbox_values', array(
				1         => esc_html__( 'Yes', 'greeny' ),
				0         => esc_html__( 'No', 'greeny' ),
			)
		);
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'greeny_get_list_onoff' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_onoff( $prepend_inherit = false ) {
		$list = array(
			'on'  => esc_html__( 'On', 'greeny' ),
			'off' => esc_html__( 'Off', 'greeny' ),
		);
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_showhide' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_showhide( $prepend_inherit = false ) {
		$list = array(
			'show' => esc_html__( 'Show', 'greeny' ),
			'hide' => esc_html__( 'Hide', 'greeny' ),
		);
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_visiblehidden' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_visiblehidden( $prepend_inherit = false ) {
		$list = array(
			'visible' => esc_html__( 'Visible', 'greeny' ),
			'hidden'  => esc_html__( 'Hidden', 'greeny' ),
		);
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_directions' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_directions( $prepend_inherit = false ) {
		$list = array(
			'horizontal' => esc_html__( 'Horizontal', 'greeny' ),
			'vertical'   => esc_html__( 'Vertical', 'greeny' ),
		);
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_paddings' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_paddings( $prepend_inherit = false ) {
		$list = apply_filters(
			'greeny_filter_list_paddings', array(
				'none'  => array(
							'title' => esc_html__( 'No Padding', 'greeny' ),
							'icon'  => 'images/theme-options/section-padding/none.png',
						),
				'small'  => array(
							'title' => esc_html__( 'Small Padding', 'greeny' ),
							'icon'  => 'images/theme-options/section-padding/small.png',
						),
				'medium' => array(
							'title' => esc_html__( 'Medium Padding', 'greeny' ),
							'icon'  => 'images/theme-options/section-padding/medium.png',
						),
				'large' => array(
							'title' => esc_html__( 'Large Padding', 'greeny' ),
...
if ( ! function_exists( 'greeny_get_list_hovers' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_hovers( $prepend_inherit = false ) {
		$list = apply_filters(
			'greeny_filter_list_hovers', array(
				'dots'    => esc_html__( 'Dots', 'greeny' ),
				'icon'    => esc_html__( 'Icon', 'greeny' ),
				'icons'   => esc_html__( 'Icons', 'greeny' ),
				'zoom'    => esc_html__( 'Zoom', 'greeny' ),
				'fade'    => esc_html__( 'Fade', 'greeny' ),
				'slide'   => esc_html__( 'Slide', 'greeny' ),
				'pull'    => esc_html__( 'Pull', 'greeny' ),
				'border'  => esc_html__( 'Border', 'greeny' ),
				'excerpt' => esc_html__( 'Excerpt', 'greeny' ),
				'info'    => esc_html__( 'Info', 'greeny' ),
			)
		);
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'greeny_get_list_blog_contents' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_blog_contents( $prepend_inherit = false ) {
		$list = array(
				'excerpt'  => esc_html__( 'Excerpt', 'greeny' ),
				'fullpost' => esc_html__( 'Full post', 'greeny' ),
		);
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_blog_paginations' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function greeny_get_list_blog_paginations( $prepend_inherit = false ) {
		$list = array(
					'pages'    => array(
					...
					'links'    => array(
										'title' => esc_html__( 'Older/Newest', 'greeny' ),
...
if ( ! function_exists( 'greeny_get_list_sidebars' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_sidebars( $prepend_inherit = false, $add_hide = false ) {
		$list = greeny_storage_get( 'list_sidebars' );
		if ( '' == $list ) {
			...
			greeny_storage_set( 'list_sidebars', $list );
		}
		if ( $add_hide ) {
			$list = greeny_array_merge( array( 'hide' => greeny_get_not_selected_text( esc_html__( 'Select widgets', 'greeny' ) ) ), $list );
		}
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_sidebars_positions' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function greeny_get_list_sidebars_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'greeny_filter_list_sidebars_positions', array(
				'hide'  => array(
							'title' => esc_html__( 'No sidebar', 'greeny' ),
							'icon'  => 'images/theme-options/sidebar-position/hide.png',
						),
				'left'  => array(
							'title' => esc_html__( 'Left sidebar', 'greeny' ),
							'icon'  => 'images/theme-options/sidebar-position/left.png',
						),
				'right' => array(
							'title' => esc_html__( 'Right sidebar', 'greeny' ),
...
if ( ! function_exists( 'greeny_get_list_sidebars_positions_ss' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_sidebars_positions_ss( $prepend_inherit = false ) {
		$list = apply_filters(
			'greeny_filter_list_sidebars_positions_ss', array(
				'above' => esc_html__( 'Above the content', 'greeny' ),
				'below' => esc_html__( 'Below the content', 'greeny' ),
				'float' => esc_html__( 'Floating bar', 'greeny' ),
			)
		);
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'greeny_get_list_sidebar_styles' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_sidebar_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'greeny_filter_list_sidebar_styles', array() );
		}
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_header_footer_types' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_header_footer_types( $prepend_inherit = false ) {
		$list = apply_filters(
			'greeny_filter_list_header_footer_types', array(
...
if ( ! function_exists( 'greeny_get_list_header_styles' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_header_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'greeny_filter_list_header_styles', array() );
		}
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_header_positions' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_header_positions( $prepend_inherit = false ) {
		$list = array(
			'default' => esc_html__( 'Default', 'greeny' ),
			'over'    => esc_html__( 'Over', 'greeny' ),
			'under'   => esc_html__( 'Under', 'greeny' ),
		);
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_footer_styles' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_footer_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'greeny_filter_list_footer_styles', array() );
		}
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_body_styles' ) ) {
	/**
	 ...
	 *                                This format used to show elements in the 'icons' style instead dropdown.
	 */
	function greeny_get_list_body_styles( $prepend_inherit = false, $force_fullscreen = false ) {
		$list = array(
			'boxed' => array(
						'title' => esc_html__( 'Boxed', 'greeny' ),
						'icon'  => 'images/theme-options/body-style/boxed.png',
					),
			'wide'  => array(
						'title' => esc_html__( 'Wide', 'greeny' ),
						'icon'  => 'images/theme-options/body-style/wide.png',
					),
		);
		if ( apply_filters( 'greeny_filter_allow_fullscreen', $force_fullscreen || greeny_get_theme_setting( 'allow_fullscreen' ) || greeny_get_edited_post_type() == 'page' ) ) {
			$list['fullwide']   = array(
									'title' => esc_html__( 'Fullwidth', 'greeny' ),
									'icon'  => 'images/theme-options/body-style/fullwide.png',
									);
			$list['fullscreen'] = array(
									'title' => esc_html__( 'Fullscreen', 'greeny' ),
									'icon'  => 'images/theme-options/body-style/fullscreen.png',
									);
		}
		$list = apply_filters( 'greeny_filter_list_body_styles', $list );
		return $prepend_inherit
					? greeny_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'greeny_get_list_expand_content' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function greeny_get_list_expand_content( $prepend_inherit = false, $narrow = false ) {
		$list = apply_filters(
			'greeny_filter_list_expand_content', array_merge(
				( $narrow
					? array(
						'narrow' => array(
								'title' => esc_html__( 'Narrow', 'greeny' ),
				...
				array(
					'normal' => array(
							'title' => esc_html__( 'Normal', 'greeny' ),
...
if ( ! function_exists( 'greeny_get_list_remove_margins' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function greeny_get_list_remove_margins( $prepend_inherit = false ) {
		$list = apply_filters(
			'greeny_filter_list_remove_margins', array(
				'0'  => array(
							'title' => esc_html__( 'Margins On', 'greeny' ),
							'icon'  => 'images/theme-options/remove-margins/on.png',
						),
				'1'  => array(
							'title' => esc_html__( 'Margins Off', 'greeny' ),
...
if ( ! function_exists( 'greeny_get_list_meta_parts' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_meta_parts( $prepend_inherit = false ) {
		$list = apply_filters(
			'greeny_filter_list_meta_parts',
			array(
				'author'     => esc_html__( 'Post author', 'greeny' ),
				'date'       => esc_html__( 'Published date', 'greeny' ),
				'modified'   => esc_html__( 'Modified date', 'greeny' ),
				'views'      => esc_html__( 'Views', 'greeny' ),
				'likes'      => esc_html__( 'Likes', 'greeny' ),
				'comments'   => esc_html__( 'Comments', 'greeny' ),
				'share'      => esc_html__( 'Share links', 'greeny' ),
				'categories' => esc_html__( 'Categories', 'greeny' ),
				'edit'       => esc_html__( 'Edit link', 'greeny' ),
			)
		);
...
if ( ! function_exists( 'greeny_get_list_share_links_positions' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_share_links_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'greeny_filter_list_share_links_positions',
			array(
...
if ( ! function_exists( 'greeny_get_list_blog_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function greeny_get_list_blog_styles( $prepend_inherit = false, $filter = 'arh', $need_custom = true ) {
		$list   = array();
					...
					if ( 'arh' == $filter && isset( $v['columns'] ) && is_array( $v['columns'] ) ) {
						...
						foreach ( $v['columns'] as $col ) {
							...
							$list[ "{$k}_{$col}" ] = 'arh' == $filter
														? array(
															'title'   => sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'greeny' ), $v['title'], $col ),
															'icon'    => ! empty( $v['icon'] )
																			? ( strpos( $v['icon'], '%d' ) !== false ? sprintf( $v['icon'], $col ) : $v['icon'] )
																			: 'images/theme-options/blog-style/custom.png',
															'new_row' => $new_row,
															)
														: sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'greeny' ), $v['title'], $col );
							$new_row = false;
						}
					} else {
						$list[ $k ] = 'arh' == $filter
		...
		$list = apply_filters( 'greeny_filter_list_blog_styles', $list, $filter, $need_custom );
		return $prepend_inherit
					? greeny_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'greeny_get_list_single_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function greeny_get_list_single_styles( $prepend_inherit = false ) {
		$list = apply_filters( 'greeny_filter_list_single_styles', greeny_storage_get( 'single_styles' ) );
		return $prepend_inherit
					? greeny_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'greeny_get_list_categories' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_categories( $prepend_inherit = false ) {
		$list = greeny_storage_get( 'list_categories' );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					$list[ $cat->term_id ] = apply_filters( 'greeny_filter_term_name', $cat->name, $cat );
				}
			}
			greeny_storage_set( 'list_categories', $list );
		}
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_terms' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_terms( $prepend_inherit = false, $taxonomy = 'category' ) {
		$list = greeny_storage_get( 'list_taxonomies_' . ( $taxonomy ) );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					...
					$list[ $cat->term_id ] = apply_filters( 'greeny_filter_term_name', $cat->name . ( false && 'category' != $taxonomy ? " /{$cat->taxonomy}/" : '' ), $cat );
				}
			}
			greeny_storage_set( 'list_taxonomies_' . ( $taxonomy ), $list );
		}
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_posts_types' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_posts_types( $prepend_inherit = false ) {
		$list = greeny_storage_get( 'list_posts_types' );
		if ( '' == $list ) {
			$list = apply_filters(
				'greeny_filter_list_posts_types', array(
					'post' => esc_html__( 'Post', 'greeny' ),
				)
			);
			greeny_storage_set( 'list_posts_types', $list );
		}
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_posts' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_posts( $prepend_inherit = false, $opt = array() ) {
		$opt = array_merge(
			array(
				'post_type'        => 'post',
				'post_status'      => 'publish',
		...
		$list = greeny_storage_get( $hash );
		if ( '' == $list ) {
			$list = array();
			if ( false !== $opt['not_selected'] ) {
				$list['none'] = true === $opt['not_selected'] ? greeny_get_not_selected_text( esc_html__( 'Not selected', 'greeny' ) ) : $opt['not_selected'];
			}
			$args = array(
...
if ( ! function_exists( 'greeny_get_list_users' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_users( $prepend_inherit = false, $roles = array( 'administrator', 'editor', 'author', 'contributor', 'shop_manager' ) ) {
		$list = greeny_storage_get( 'list_users' );
		if ( '' == $list ) {
			$list         = array();
			$list['none'] = greeny_get_not_selected_text( esc_html__( 'Not selected', 'greeny' ) );
			$users        = get_users(
				array(
			...
			greeny_storage_set( 'list_users', $list );
		}
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_menus' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_menus( $prepend_inherit = false ) {
		$list = greeny_storage_get( 'list_menus' );
		if ( '' == $list ) {
			$list            = array();
			$list['default'] = esc_html__( 'Default', 'greeny' );
			...
			greeny_storage_set( 'list_menus', $list );
		}
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_icons' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_icons( $style ) {
		$lists = get_transient( 'greeny_list_icons' );
		if ( ! is_array( $lists ) || ! isset( $lists[ $style ] ) || ! is_array( $lists[ $style ] ) || count( $lists[ $style ] ) < 2 ) {
			if ( 'icons' == $style ) {
				$lists[ $style ] = greeny_array_from_list( greeny_get_list_icons_classes() );
			} elseif ( 'images' == $style ) {
				$lists[ $style ] = greeny_get_list_images();
			} else { // 'svg'
				$lists[ $style ] = greeny_get_list_images( false, 'svg' );
			}
			if ( is_admin() && is_array( $lists[ $style ] ) && count( $lists[ $style ] ) > 1 ) {
				set_transient( 'greeny_list_icons', $lists, 6 * 60 * 60 );       // Store to the cache for 6 hours
			}
		}
		return $lists[ $style ];
	}
...
if ( ! function_exists( 'greeny_get_list_icons_classes' ) ) {
	/**
	 ...
	 * @return array                  An associative array with icons.
	 */
	function greeny_get_list_icons_classes( $prepend_inherit = false ) {
		static $list = false;
		if ( ! is_array( $list ) ) {
			$list = ! is_admin() ? array() : greeny_parse_icons_classes( greeny_get_file_dir( 'css/font-icons/css/fontello-codes.css' ) );
		}
		$list = greeny_array_merge( array( 'none' => 'none' ), $list );
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'greeny_get_list_images' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_images( $prepend_inherit = false, $type = 'png' ) {
...
if ( ! function_exists( 'greeny_get_list_sc_color_styles' ) ) {
	/**
	 ...
	 */
	function greeny_get_list_sc_color_styles( $prepend_inherit = false ) {
		$list = apply_filters(
			'greeny_filter_get_list_sc_color_styles', array(
				'default' => esc_html__( 'Default', 'greeny' ),
				'link2'   => esc_html__( 'Accent 2', 'greeny' ),
				'link3'   => esc_html__( 'Accent 3', 'greeny' ),
				'dark'    => esc_html__( 'Dark', 'greeny' ),
			)
		);
		return $prepend_inherit ? greeny_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'greeny' ) ), $list ) : $list;
	}
