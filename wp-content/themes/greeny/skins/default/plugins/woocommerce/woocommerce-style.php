...
if ( ! function_exists( 'greeny_woocommerce_get_css' ) ) {
	add_filter( 'greeny_filter_get_css', 'greeny_woocommerce_get_css', 10, 2 );
	function greeny_woocommerce_get_css( $css, $args ) {
...
$fdir = greeny_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
