== Greeny ==
Version: 1.0
Copyright: 2020, AxiomThemes
WordPress version: required at least 5.0, tested up to 5.9
...
Please install and activate it before starting to use the theme Greeny.
...
Theme documentation is available on https://greeny.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Greeny is Fontello.
